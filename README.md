...
<div align="center">
  ...
  <a href="./LICENSE">
    <img src="https://img.shields.io/github/license/charles-future/mcp-gateway" alt="License">
  </a>
...
1. Create a file with sensitive information:
   ```bash
   echo 'HF_TOKEN = "hf token"' > tokens.txt
   ```
...
<-- auto-comment Wed 12/10/2025 22:49:19 (debug/utils-5087) 
<-- auto-comment Wed 12/10/2025 22:49:19 (debug/utils-5087) 
<-- auto-comment Wed 01/07/2026  0:10:28 (feature/routes-1772) 
<-- auto-comment Wed 01/07/2026  0:10:28 (feature/routes-1772) 
